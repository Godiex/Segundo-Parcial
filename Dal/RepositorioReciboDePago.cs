...
namespace Dal
{
    public class RepositorioReciboDePago
    {
        ...
        public string Ruta = @"Recibos De Pago.txt";
        ...
        public ReciboDePago Buscar(string idReciboDePago)
        {
            Consultar();
            return recibosDePago.Where(Rp => Rp.IdReciboPago.Equals(idReciboDePago)).First();
        }
